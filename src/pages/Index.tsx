...
const Index = () => {
  ...
  return (
    <div className={`app-shell travel-bg ${themeClass} ${modeClass}`}>
      {/* Background overlay MUST be behind content, but ABOVE background */}
      ...
      {/* Everything visible must be inside this layer */}
            ...
            <main id="plan" className="container mx-auto px-4 pb-16">
              <div className="mx-auto max-w-2xl">
                <div className="text-center mb-10">
                  <h2 className="font-display text-3xl font-semibold text-foreground mb-3">Plan My Holiday Cost</h2>
                  <p className="text-muted-foreground leading-relaxed max-w-lg mx-auto">
                    Get a clear estimate of your full holiday — flights, hotel, car rental, and daily expenses.
                  </p>
                  <p className="text-muted-foreground/80 text-sm mt-2">No booking. No commitment. Just clarity.</p>
                </div>
