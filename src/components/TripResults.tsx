    ...
    <Card className="w-full">
      ...
      <CardContent>
        <div className="grid gap-4">
          {/* ✅ MOBILE RESPONSIVE ESTIMATED TOTAL */}
            ...
            <div className="space-y-2">
              ...
              {tripPlan.outboundFlight && (
                <Card className={cn(!tripPlan.outboundFlight.included && "opacity-50")}>
                  {/* ✅ MOBILE RESPONSIVE: Added overflow-hidden and flex-wrap */}
                  <CardContent className="p-3 sm:p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 overflow-hidden">
                    ...
                    {/* ✅ MOBILE RESPONSIVE: Added min-w-fit to prevent price squeezing */}
          ...
          {tripPlan.hotel ? (
            <div className="space-y-2">
              ...
              <Card className={cn(!tripPlan.hotel.included && "opacity-50")}>
                ...
                <CardContent className="p-3 sm:p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 overflow-hidden">
                  <div className="min-w-0 flex-1">
                    <p className="font-medium text-sm sm:text-base break-words">{tripPlan.hotel.name}</p>
                    <p className="text-xs sm:text-sm text-gray-500">
                      ⭐ {tripPlan.hotel.rating}/5 • {tripPlan.hotel.distanceFromAirport} from airport
                    </p>
                    <p className="text-xs sm:text-sm text-gray-500 break-words">{tripPlan.hotel.address}</p>
          ...
          {tripPlan.carRental ? (
            <div className="space-y-2">
              ...
              <Card className={cn(!tripPlan.carRental.included && "opacity-50")}>
                ...
                <CardContent className="p-3 sm:p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 overflow-hidden">
                  <div className="min-w-0 flex-1">
                    <p className="font-medium text-sm sm:text-base break-words">{tripPlan.carRental.vehicleName}</p>
                    <p className="text-xs sm:text-sm text-gray-500">{tripPlan.carRental.company}</p>
                    <p className="text-xs sm:text-sm text-gray-500">
